<div class="conatiner-fluid d-flex flex-col space-x-2 relative bg-gray-100">
        <div class="w-full d-flex flex-row flex-wrap items-center">
            @foreach ($produtos as $produto)
            <div class="basis-2/5 ml-4 m-auto">
